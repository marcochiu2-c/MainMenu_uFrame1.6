	...
	void MobileInput ()
	{
		...
		if (Input.touchCount == 1) 
		{
			...
			} else if (Input.touches [0].phase == TouchPhase.Moved) 
			{
				...
				var inputX = -Input.touches [0].deltaPosition.x * Time.deltaTime * 50;
				var inputY = -Input.touches [0].deltaPosition.y * Time.deltaTime * 50;
				//移動攝影機
				Camera.main.transform.Translate (new Vector3 (inputX, inputY, 0));
			}
