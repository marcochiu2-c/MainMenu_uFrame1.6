...
public class Generals
{
	...
	public Generals(string n, int r, string e, int t,int iIQ, 
	...
	public Generals (SimpleJSON.JSONClass j, int cnt=1){
		id = cnt;
		Name = j ["Name"];
		Rank = j["Rank"].AsInt;
		Era = j["Era"];
