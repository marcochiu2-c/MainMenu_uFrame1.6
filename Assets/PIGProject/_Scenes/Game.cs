...
public class Game {
	...
	public void parseJSON(string json){
		...
		for (int i=0; i<count; i++) {
			...
			warfare[i].attackerGeneral = j["warfare"][i]["attackerGeneral"].AsInt;
			warfare[i].defenderGeneral = j["warfare"][i]["defenderGeneral"].AsInt;
...
public class Warfare {
	...
	public int attackerGeneral { get; set; }
	public int defenderGeneral { get; set; }
	...
	public JSONClass toJSON(){
		...
		j.Add ("attackerGeneral", new JSONData (attackerGeneral));
		j.Add ("defenderkerGeneral", new JSONData (defenderGeneral));
