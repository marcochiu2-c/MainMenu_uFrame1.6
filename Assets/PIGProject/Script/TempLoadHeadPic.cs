...
public class TempLoadHeadPic : MonoBehaviour
{
	...
	private void SetCharacters(){
		...
		imageDict.Add(/*"單雄信",*/ 1071,SinHongShun);
		...
		imageDict.Add(/*"宗澤",*/ 1064,JungJaak);
		...
		imageDict.Add(/*"張叔夜",*/ 1066,CheungShukYe);
		imageDict.Add(/*"張良",*/ 10,CheungLeung);
		imageDict.Add(/*"張遼",*/ 1079,CheungLiu);
		imageDict.Add(/*"張郃",*/ 1022,CheungHop);
		imageDict.Add(/*"張飛",*/ 1015,CheungFei);
		imageDict.Add(/*"徐達",*/ 1036,ChuiTat);
		imageDict.Add(/*"惡來",*/ 1074,NgouLoi);
		imageDict.Add(/*"慕容延釗",*/ 1068,MoYungYinChiu);
		imageDict.Add(/*"戚繼光",*/ 1039,ChikGaiGwong);
		imageDict.Add(/*"施琅",*/ 1062,SiLong);
		...
		imageDict.Add(/*"畢再遇",*/ 1063,ButJoiYu);
		imageDict.Add(/*"白起",*/ 1006,PakHei);
		imageDict.Add(/*"秦良玉",*/ 1057,ChunLeungYuk);
		imageDict.Add(/*"程咬金",*/ 1072,ChingNgauGam);
		...
		imageDict.Add(/*"賀若弼",*/ 1077,HoYeukBut);
		...
		imageDict.Add(/*"鄭仁泰",*/ 1065,ChengYanTai);
		...
		nameDict.Add(25,"于謙");
		nameDict.Add(4,"伍子胥");
		nameDict.Add(1075,"伯嚭");
		nameDict.Add(1069,"先軫");
		nameDict.Add(1059,"冼英");
		nameDict.Add(11,"劉基");
		nameDict.Add(14,"劉秉忠");
		nameDict.Add(1067,"史彌堅");
		nameDict.Add(1028,"史思明");
		nameDict.Add(1076,"史萬歲");
		nameDict.Add(23,"司馬懿");
		...
		nameDict.Add(20,"田穰苴");
		nameDict.Add(1063,"畢再遇");
		nameDict.Add(1006,"白起");
		nameDict.Add(1057,"秦良玉");
		nameDict.Add(1072,"程咬金");
