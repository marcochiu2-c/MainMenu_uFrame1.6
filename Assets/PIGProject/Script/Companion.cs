...
//	public static GameObject static;
	WsClient wsc;
	Game game;
	...
	public void CallAcademy(){
		...
		SetDictionary ();
		Debug.Log ("Supposed to be CompanionHolder: "+transform);
		Debug.Log ("Supposed to be base panel of CompanionHolder: "+transform.GetChild(1));
...
//		staticCompanionHolder = CompanionHolder;
